...
void ::Command_Computer::DirectXPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::Command_Computer::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 3:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element3))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::Command_Computer::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::Command_Computer::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
